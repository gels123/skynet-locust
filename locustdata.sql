...
-- ----------------------------
INSERT INTO `conf_cluster` (`nodeid`, `nodename`, `ip`, `web`, `listen`, `listennodename`, `port`, `portdebug`, `porthttp`) VALUES (1, 'node_locust', '127.0.0.1', '127.0.0.1', '0.0.0.0', 'listen_node_locust', 7000, 7002, 7001) ON DUPLICATE KEY UPDATE nodeid = 1;
